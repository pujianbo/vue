 ...
 */
//查询所有角色
export const getAllRoles  = () => fetch('/api/roles');
//创建根角色
export const createRoleRoot = (data) =>fetch(`/api/role/creation`,data,'POST');
//创建子角色
export const createRoleChild = (data,id) =>fetch(`/api/role/${id}/creation`,data,'POST');
//删除角色
export const removeRole = (id) =>fetch(`/api/role/${id}/delete`,{},'DELETE');
//修改角色名称
export const editRole = (data,id) =>fetch(`/api/role/${id}/update`,data,'PUT');
//拖动角色
export  const dragRole = (data,beforeId,afterId) => fetch(`/api/role/${beforeId}/move/${afterId}`,data,'POST');
/*
*权限
 */
//查询所有权限
export const getAllPermission  = () => fetch('/api/permissions');
//创建根权限
export const createPermRoot = (data) =>fetch(`/api/permission/creation`,data,'POST');
//创建子权限
export const createPermChild = (data,id) =>fetch(`/api/permission/${id}/creation`,data,'POST');
//删除权限
export const removePerm = (id) =>fetch(`/api/permission/${id}/delete`,{},'DELETE');
//修改角权限称
export const editPerm = (data,id) =>fetch(`/api/permission/${id}/update`,data,'PUT');
//拖动权限
export  const dragPerm = (data,beforeId,afterId) => fetch(`/api/permission/${beforeId}/move/${afterId}`,data,'POST');
